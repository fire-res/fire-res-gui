...
import io.github.fireres.gui.unheated.surface.synchronizer.SecondaryGroupChartSynchronizer;
...
@FxmlView("secondaryGroupChart.fxml")
@RequiredArgsConstructor
@Component
@Scope(scopeName = SCOPE_PROTOTYPE)
public class SecondaryGroupChart extends AbstractComponent<StackPane>
        implements UnheatedSurfaceReportContainer, ChartContainer {

    @FXML
    private LineChart<Number, Number> chart;

    private final SecondaryGroupChartSynchronizer chartSynchronizer;
