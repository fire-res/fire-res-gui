...
import static io.github.fireres.gui.model.ElementIds.FIRST_THERMOCOUPLE_GROUP_MEAN_BOUND_TEMPERATURE_LINE;
import static io.github.fireres.gui.model.ElementIds.FIRST_THERMOCOUPLE_GROUP_THERMOCOUPLE_MAX_TEMPERATURE_LINE;
import static io.github.fireres.gui.model.ElementIds.FIRST_THERMOCOUPLE_GROUP_THERMOCOUPLE_TEMPERATURE_LINE;
...
@Component
public class PrimaryGroupChartSynchronizer implements ChartSynchronizer<UnheatedSurfaceReport> {
    ...
    private void addMeanBoundLine(LineChart<Number, Number> chart, UnheatedSurfaceReport report) {
        ...
        addPointsToSeries(series, report.getMaxAllowedMeanTemperature());
        chart.getData().add(series);
